      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <a
                href="https://www.instagram.com/gloss_ifi"
                target="_blank"
              ...
              <a
                href="https://facebook.com/profile.php?id=61582502571869&_rdc=1&_rdr#"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-brand-lavender transition-colors"
                aria-label="Facebook"
              ...
              <a
                href="https://www.tiktok.com/@gloss_ifi"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white hover:text-brand-lavender transition-colors"
                aria-label="TikTok"
          ...
          <div>
            <h4 className="font-semibold mb-4 text-white">Reach Us through</h4>
            <div className="space-y-3 text-slate-400">
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:glossyprint2025@gmail.com" className="hover:text-brand-lavender transition-colors text-sm">
                  glossyprint2025@gmail.com
                </a>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+201030138275" className="hover:text-brand-lavender transition-colors text-sm">
                  +201030138275
                </a>
              </div>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-slate-400">
          <p>&copy; {new Date().getFullYear()} Glossifi. All rights reserved</p>
        </div>
      </div>
    </footer>
  )
